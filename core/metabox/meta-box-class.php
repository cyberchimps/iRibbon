...
class RW_Meta_Box {
	...
	function show_field_pagehelp($field, $meta) {
		global $ir_themenamefull, $ir_pagedocs; 
		
		$this->show_field_begin($field, $meta);
		echo "Visit our $ir_themenamefull Page Options help page here: <a href='$ir_pagedocs' target='_blank'>Page Options Documentation</a></td>";
	}
		
	function show_field_sliderhelp($field, $meta) {
		global $ir_themenamefull, $ir_sliderdocs;
		
		$this->show_field_begin($field, $meta);
		echo "Visit our $ir_themenamefull Slider help page here: <a href='$ir_sliderdocs' target='_blank'>Slider Documentation</a></td>";
	}
		...
		echo "<div class='list_items'>";
			foreach($field['options'] as $key => $value) {
				...
				echo "<div class='list_item'>";
					echo "<img src='$ir_root/images/minus.png' class='action' title='Remove'/>";
					echo "<span data-key='{$key}'>{$value}</span>";
				echo "</div>";
			}
		echo "</div>";
		echo "</div>";
		echo "<div id='arrow'><img src='$ir_root/images/arrowdrag.png' /></div>";
