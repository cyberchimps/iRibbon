<?php
global $options, $ir_themeslug, $ir_themenamefull, $ir_root;
...
class ClassyOptions {
	...
	function admin_menu() {
		global $ir_themenamefull;
		
		$page = add_theme_page( $ir_themenamefull.' Options', $ir_themenamefull.' Options', 'edit_theme_options', $this->id, array( $this, 'render' ) );
	...
	function load_scripts() {
		...
		wp_enqueue_script('theme-options-custom', $ir_root . '/library/js/theme-options-custom.js', array('jquery'));
		wp_enqueue_script('media-uploader', CLASSY_OPTIONS_FRAMEWORK_URL.'js/of-medialibrary-uploader.js', array('jquery'));
		wp_enqueue_script('custom', $ir_root . '/core/library/js/custom.js', array('jquery') );
	}
	...
	function render() {
		global $ir_themenamefull, $ir_root;
		settings_errors(); ?>
<div class="wrap">
<div class="upgrade-callout">
<p><img src="<?php echo $ir_root ;?>/images/chimp.png" alt="CyberChimps" /><strong>Welcome to <?php echo $ir_themenamefull; ?>! Learn more now about upgrading to <a href="http://cyberchimps.com/iribbonpro/" target="_blank"><?php echo $ir_themenamefull; ?> Pro</a> today.</p>
...
<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fcyberchimps.com%2F&amp;send=false&amp;layout=button_count&amp;width=200&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:200px; height:21px;" allowTransparency="true"></iframe>
	...
	<div id="of_container">
		<form action="options.php" method="post" enctype="multipart/form-data">
			...
			<div id="header">
				<div class="logo">
				<h2><?php echo $ir_themenamefull; ?> Options</h2>
				</div>
				<div class="upgradepro"><a href="http://cyberchimps.com/iribbonpro/" target="_blank">Upgrade to iRibbon Pro</a>
				</div>
				<div class="clear"></div>
					<p class="submit">
			...
			<div class="of_admin_bar">
			    <div id="top"><a href='#TOP'><img src="<?php echo $ir_root ;?>/images/options/top.png" /></a></div>
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'iribbon' ) ); ?>' );" />
				<div class="chimps"><a href="http://cyberchimps.com/" target="_blank"><img src="<?php echo $ir_root ;?>/images/options/cyberchimpsmini.png" /></a></div>
			</div>
			<div class="clear"></div> 
		</form>
	</div> <!-- / #of_container -->  
	...
	function fields() {
		...
		foreach ($options as $value) {
			...
			case "section_order":
				...
				$output .=  "</div>";
				$output .=  "</div>";
				$output .=  "<div class='arrow'><img src='$ir_root/images/arrowdrag.png' /></div>";
