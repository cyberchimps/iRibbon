<?php
global $options, $ir_themeslug, $ir_themenamefull;
...
<p><img src="<?php echo get_template_directory_uri() ;?>/images/chimp.png" alt="CyberChimps" /><strong><?php echo $ir_themenamefull; ?> has successfully been installed.</strong> Want more features? <a href="http://cyberchimps.com/iribbonpro/" target="_blank">Learn more about upgrading to <?php echo $ir_themenamefull; ?> Pro.</a>
<span class="twitter">
