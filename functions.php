...
function cyberchimps_iribbon_upgrade_bar(){
...
?>	
	...
	<div class="upgrade-callout">
		<p><img src="<?php echo get_template_directory_uri(); ?>/cyberchimps/options/lib/images/chimp.png" alt="CyberChimps"/>
			<?php printf(
				__( 'Welcome to iRibbon! Get 30%% off on %1$s using Coupon Code <span style="color:red">IRIBBON30</span>', 'cyberchimps_core' ),
...
if( cyberchimps_theme_check() == 'free' ) {
	add_action( 'cyberchimps_options_before_container', 'cyberchimps_iribbon_upgrade_bar' );
}
?>
